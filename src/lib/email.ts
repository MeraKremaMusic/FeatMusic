...
export async function enviarReporteUsuarioPorCorreo({
  ...
  await transportador.sendMail({
    from: configuracion.remitente,
    to: destinatario,
    subject: `[FeatMusic] Reporte #${reporteId} sobre @${reportado}`,
...
El reporte quedó guardado en el panel de administración de FeatMusic.`,
    html: `
        ...
        <div style="max-width:640px;margin:auto;overflow:hidden;border:1px solid #dbe4ea;border-radius:18px;background:#ffffff">
          ...
          <div style="padding:26px">
            <table style="width:100%;border-collapse:collapse;font-size:14px">
              <tr><td style="padding:10px;border-bottom:1px solid #e2e8f0;font-weight:700">Reporte</td><td style="padding:10px;border-bottom:1px solid #e2e8f0">#${reporteId}</td></tr>
            ...
            <p style="margin:20px 0 0;font-size:11px;line-height:1.6;color:#64748b">El reporte #${reporteId} quedó guardado en el panel de administración. Este correo funciona como aviso secundario.</p>
          </div>
        </div>
      </div>
    `,
