    ...
    <main className="min-h-screen bg-black text-white">
      ...
      >
        ...
        <div className="mobile-hero-content mx-auto flex min-h-[100svh] max-w-7xl flex-col items-center justify-center px-5 pb-16 pt-28 text-center sm:px-6 sm:pt-24 md:-translate-y-1">
          ...
          <div className="hero-actions-enter mt-6 flex w-full max-w-sm flex-col gap-3 sm:mt-10 sm:w-auto sm:max-w-none sm:flex-row sm:gap-4">
            <Link
              href="/registro"
              className="rounded-full bg-[#FFD400] px-8 py-4 font-semibold text-black transition hover:-translate-y-0.5 hover:bg-[#ffe033]"
            >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-yellow-600 text-white transition hover:scale-105 hover:bg-yellow-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-300 xl:h-10 xl:w-10"
                      >
                        <GraphicIcon
      ...
      >
        ...
        <div className="mobile-cta-content reveal-on-scroll mx-auto w-full max-w-3xl">
          ...
          <Link
            href="/registro"
            className="mt-10 inline-flex rounded-full bg-[#FFD400] px-8 py-4 font-semibold text-black shadow-2xl transition hover:-translate-y-0.5 hover:bg-[#ffe033]"
          >
            {copy.cta.action}
          </Link>
        </div>
