...
import DescripcionIdea from "./[nombreUsuario]/components/DescripcionIdea";
...
function TarjetaArtista({
  ...
  return (
    <article className="group relative z-0 flex h-full min-h-[290px] flex-col overflow-visible rounded-2xl border border-white/[0.09] bg-[linear-gradient(145deg,rgba(255,255,255,0.035),rgba(0,0,0,0.2)_45%,rgba(221,180,18,0.035))] shadow-[0_18px_50px_rgba(0,0,0,0.18)] transition duration-300 hover:z-20 hover:-translate-y-0.5 hover:border-yellow-400/25 hover:shadow-[0_22px_60px_rgba(0,0,0,0.28)]">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex min-w-0 items-start justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="featmusic-explore-card-username mt-0.5 truncate text-[11px] font-semibold text-[#FFD400]">
                ...
                >
                  ...
                  {mostrarDetalle && (
                    <DescripcionIdea
                      ...
                      contenedorClassName="featmusic-explore-description-control absolute right-0 top-[18px] z-30"
                      botonClassName="inline-flex h-[26px] items-center gap-1.5 rounded-lg !border-0 !bg-white px-2.5 text-[10px] font-bold !text-black shadow-sm transition hover:!bg-zinc-100 focus:outline-none focus:ring-2 focus:ring-white/40"
