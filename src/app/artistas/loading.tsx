    ...
    <main className="relative flex h-[100dvh] min-h-[100dvh] flex-col overflow-hidden bg-[#09070d] text-white">
      <header className="relative z-20 border-b border-white/10 bg-black/90 backdrop-blur-xl">
        <div className="relative mx-auto flex h-12 max-w-[1460px] items-center justify-between px-4">
          ...
          >
            <button
              type="button"
              className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-[11px] font-semibold text-zinc-400"
            >
          ...
          <form action="/api/cerrar-sesion" method="post">
            <button
              type="submit"
              className="flex items-center gap-2 rounded-lg border border-red-400/50 px-3 py-1.5 text-[10px] font-bold text-red-300"
            >
      ...
      >
        <div className="mx-auto grid max-w-md grid-cols-5 items-end">
          <Link
            href="/panel"
            className="flex min-w-0 flex-col items-center justify-center gap-1 rounded-xl px-1 py-1.5 text-zinc-500"
          >
            <Icono tipo="inicio" />
