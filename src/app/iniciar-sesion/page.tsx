  ...
  <>
    ...
    <main className="flex min-h-screen items-center justify-center bg-black px-6 text-white">
      <section className="w-full max-w-md rounded-3xl border border-zinc-800 bg-zinc-950 p-8">
        ...
        <p className="mt-8 text-sm font-semibold text-yellow-400">
          Bienvenido de nuevo
        </p>
        ...
        {exito === "password-restablecida" ? (
          <p className="mt-6 rounded-xl border border-yellow-500/25 bg-yellow-500/10 p-4 text-sm text-yellow-200">
        ...
        <form action="/api/iniciar-sesion" method="post" className="mt-8 space-y-5">
          <label className="block">
            ...
            <input
              ...
              className="w-full rounded-xl border border-zinc-800 bg-black px-4 py-3 outline-none focus:border-yellow-500"
            />
          </label>
          ...
          <button
            type="submit"
            className="w-full rounded-full bg-yellow-600 px-6 py-4 font-semibold hover:bg-yellow-500"
          >
            Entrar
          </button>
        </form>
        ...
        <p className="mt-5 text-right text-sm">
          <Link href="/recuperar-contrasena" className="text-yellow-400 hover:text-yellow-300">
