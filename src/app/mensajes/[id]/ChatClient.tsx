...
export default function ChatClient({
  ...
  }, [conversacionId, cuentaEliminada]);
  ...
  async function enviarMensaje(event?: FormEvent) {
    ...
    if (!texto || enviando || cuentaEliminada) {
      return;
    }
        ...
        <div className="shrink-0 border-b border-white/10 px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            ...
            {cuentaEliminada ? (
              ...
              >
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-zinc-700 bg-zinc-900 text-[10px] font-black text-zinc-500">
                  FM
                </span>
                ...
                {cuentaEliminada ? (
                  <>
                    <p className="text-sm font-bold text-zinc-300">
                      Esta conversación ya no está activa
                    </p>
                    <p className="mt-2 text-[10px] leading-4 text-zinc-600">
                      La otra cuenta fue eliminada y ya no es posible iniciar nuevos mensajes.
                    </p>
                  </>
                ) : (
                  <>
        ...
        {cuentaEliminada ? (
          <div className="shrink-0 border-t border-white/10 bg-black/30 px-4 py-4 text-center">
            ...
            <p className="mt-1 text-[10px] leading-4 text-zinc-500">
              Ya no puedes enviar mensajes. El historial anterior se conserva como referencia de la colaboración.
            </p>
          </div>
        ) : (
          <form
